...
public class RoleFieldPermissionsController {
	...
	public Result queryByPage(RoleFieldPermissionsVO roleFieldPermissionsVO, PageRequest pageRequest) {
		return Result.success(this.iRoleFieldPermissionsService.queryByPage(roleFieldPermissionsVO, pageRequest));
	}
