...
import com.soft.park.enums.ConstEnum;
...
public class RedisUtils {
	 ...
	 * @return key
	 */
	public String keyBuilder(String... args) {
		StringBuilder key = new StringBuilder(ConstEnum.REDIS.KEY_PREFIX.code);
		// KEY_SPLIT_CHAR 为分割字符
		for (String arg : args) {
			key.append(ConstEnum.REDIS.KEY_SPLIT_CHAR.code).append(arg);
		}
		return key.toString();
	}
